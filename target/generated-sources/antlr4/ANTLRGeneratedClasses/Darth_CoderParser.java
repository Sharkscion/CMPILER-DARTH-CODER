...
public class Darth_CoderParser extends Parser {
	...
	public static class CalculateContext extends StartContext {
		...
		public TerminalNode NL() { return getToken(Darth_CoderParser.NL, 0); }
		public CalculateContext(StartContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitCalculate(this);
	...
	public static class ToMultOrDivContext extends PlusOrMinusContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitToMultOrDiv(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PlusContext extends PlusOrMinusContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitPlus(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MinusContext extends PlusOrMinusContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitMinus(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MultiplicationContext extends MultOrDivContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitMultiplication(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ToUnaryMinusContext extends MultOrDivContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitToUnaryMinus(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ModuloContext extends MultOrDivContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitModulo(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class DivisionContext extends MultOrDivContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitDivision(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ChangeMinusSignContext extends UnarySignContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitChangeMinusSign(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ChangePlusSignContext extends UnarySignContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitChangePlusSign(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ToAtomContext extends UnarySignContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitToAtom(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionIdentifierContext extends AtomContext {
		public TerminalNode FUNC_IDEN() { return getToken(Darth_CoderParser.FUNC_IDEN, 0); }
		public FunctionIdentifierContext(AtomContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitFunctionIdentifier(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BracesContext extends AtomContext {
		public TerminalNode LPAR() { return getToken(Darth_CoderParser.LPAR, 0); }
		public PlusOrMinusContext plusOrMinus() {
			return getRuleContext(PlusOrMinusContext.class,0);
		}
		public TerminalNode RPAR() { return getToken(Darth_CoderParser.RPAR, 0); }
		public BracesContext(AtomContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitBraces(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class StringIdentifierContext extends AtomContext {
		public TerminalNode LEGION_LIT() { return getToken(Darth_CoderParser.LEGION_LIT, 0); }
		public StringIdentifierContext(AtomContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitStringIdentifier(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IntContext extends AtomContext {
		public TerminalNode INT() { return getToken(Darth_CoderParser.INT, 0); }
		public IntContext(AtomContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitInt(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class VariableIdentifierContext extends AtomContext {
		public TerminalNode VAR_IDEN() { return getToken(Darth_CoderParser.VAR_IDEN, 0); }
		public VariableIdentifierContext(AtomContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitVariableIdentifier(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CharacterIdentifierContext extends AtomContext {
		public TerminalNode UNIT_LIT() { return getToken(Darth_CoderParser.UNIT_LIT, 0); }
		public CharacterIdentifierContext(AtomContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Darth_CoderVisitor ) return ((Darth_CoderVisitor<? extends T>)visitor).visitCharacterIdentifier(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final AtomContext atom() throws RecognitionException {
		...
		try {
			...
			case FUNC_IDEN:
				...
				break;
			case UNIT_LIT:
				_localctx = new CharacterIdentifierContext(_localctx);
	...
	public static final String _serializedATN =
		...
		"\n\5\3\6\3\6\3\6\3\6\3\6\3\6\3\6\3\6\3\6\5\6@\n\6\3\6\2\4\4\6\7\2\4\6"+
		"\b\n\2\2I\2\f\3\2\2\2\4\20\3\2\2\2\6\36\3\2\2\2\b\64\3\2\2\2\n?\3\2\2"+
		"\2\f\16\5\4\3\2\r\17\7\5\2\2\16\r\3\2\2\2\16\17\3\2\2\2\17\3\3\2\2\2\20"+
		"\21\b\3\1\2\21\22\5\6\4\2\22\33\3\2\2\2\23\24\f\5\2\2\24\25\7\7\2\2\25"+
		"\32\5\6\4\2\26\27\f\4\2\2\27\30\7\b\2\2\30\32\5\6\4\2\31\23\3\2\2\2\31"+
		"\26\3\2\2\2\32\35\3\2\2\2\33\31\3\2\2\2\33\34\3\2\2\2\34\5\3\2\2\2\35"+
		"\33\3\2\2\2\36\37\b\4\1\2\37 \5\b\5\2 ,\3\2\2\2!\"\f\6\2\2\"#\7\t\2\2"+
		"#+\5\b\5\2$%\f\5\2\2%&\7\n\2\2&+\5\b\5\2\'(\f\4\2\2()\7\13\2\2)+\5\b\5"+
		"\2*!\3\2\2\2*$\3\2\2\2*\'\3\2\2\2+.\3\2\2\2,*\3\2\2\2,-\3\2\2\2-\7\3\2"+
		"\2\2.,\3\2\2\2/\60\7\b\2\2\60\65\5\n\6\2\61\62\7\7\2\2\62\65\5\n\6\2\63"+
		"\65\5\n\6\2\64/\3\2\2\2\64\61\3\2\2\2\64\63\3\2\2\2\65\t\3\2\2\2\66@\7"+
		"\3\2\2\678\7\f\2\289\5\4\3\29:\7\r\2\2:@\3\2\2\2;@\7\17\2\2<@\7\20\2\2"+
		"=@\7\21\2\2>@\7\22\2\2?\66\3\2\2\2?\67\3\2\2\2?;\3\2\2\2?<\3\2\2\2?=\3"+
		"\2\2\2?>\3\2\2\2@\13\3\2\2\2\t\16\31\33*,\64?";
