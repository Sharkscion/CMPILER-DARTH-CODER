...
public class CalculatorParser extends Parser {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(32); match(MULT);
						setState(33); unarySign();
						}
						break;
					case 2:
						{
					...
					case 3:
						...
						setState(37);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(38); match(MOD);
						setState(39); unarySign();
						}
						break;
					}
					} 
			...
			default:
				{
					...
					String tokenError = e.getStartToken().getText();
					String messageError = "no viable alternative at input \'"+ tokenError +"\'";
					CalculatorRunner.parser.notifyErrorListeners(messageError);
				}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 1: return plusOrMinus_sempred((PlusOrMinusContext)_localctx, predIndex);
		case 2: return multOrDiv_sempred((MultOrDivContext)_localctx, predIndex);
		}
		return true;
	}
